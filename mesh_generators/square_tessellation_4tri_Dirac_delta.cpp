...
int main(int ac, char** av){
	...
	std::string ply_fileName = "../synthetic_meshes/square_tesselation_4tri_Dirac_delta_"+std::to_string(radius)+"_v"+std::to_string(numVertices)+"_f"+std::to_string(numFaces)+".ply";
